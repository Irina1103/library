package com.company.utilitylibrary;
...
public class UtilitylibraryTestContainer extends TestContainer {

    public UtilitylibraryTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/utilitylibrary/app.properties",
    ...
    public static class Common extends UtilitylibraryTestContainer {

        public static final UtilitylibraryTestContainer.Common INSTANCE = new UtilitylibraryTestContainer.Common();
